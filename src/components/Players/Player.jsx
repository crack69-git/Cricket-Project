...
import SelectedDiv from '../SelectedPlayers/selectdiv';
    ...
    return (
        <div className='container mx-auto'>
            <div className='flex justify-between items-center'>
                <h2 className='text-2xl font-semibold'>{isAvailable ? "Available Players" : `Selected Players (${selectedPlayers.length}/${playerPromise.value.length})`}</h2>
                <div className='flex '>
